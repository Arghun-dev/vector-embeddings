...
## Having multi-conversational with AI (AI memory)

With a very simple approach with `appending` the response from AI to your `chatMessages` array everytime you make AI to remember your previous conversations.
